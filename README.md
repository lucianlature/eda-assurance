...
Extractors map topology from EventCatalog, AsyncAPI 2/3, Nest decorators/CQRS/Kafka topics, AWS EventBridge/SNS/SQS, KafkaJS/Avro, pg-listen/NOTIFY, Castore/Emmett and domain `{ type, payload }` events, **CloudEvents**, NATS, and TypeScript event packages. Demo walkthrough: [`docs/06-demo-scenario.md`](docs/06-demo-scenario.md).
