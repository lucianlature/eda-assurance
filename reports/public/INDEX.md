...
| [asyncapi/modelina](https://github.com/asyncapi/modelina) | 9 | 7 | `asyncapi, pg-listen` | [findings](modelina/findings.md) · [topology](modelina/topology.yaml) |
...
| [ngaxavi/nest-cqrs](https://github.com/ngaxavi/nest-cqrs) | 4 | 4 | `nest` | [findings](nest-cqrs/findings.md) · [topology](nest-cqrs/topology.yaml) |
...
| [ag2ai/faststream](https://github.com/ag2ai/faststream) | 4 | 2 | `asyncapi, kafkajs` | [findings](faststream/findings.md) · [topology](faststream/topology.yaml) |
| [laudspeaker/laudspeaker](https://github.com/laudspeaker/laudspeaker) | 3 | 1 | `nats-node, nest` | [findings](laudspeaker/findings.md) · [topology](laudspeaker/topology.yaml) |
...
| [stoplightio/spectral](https://github.com/stoplightio/spectral) | 3 | 1 | `asyncapi` | [findings](spectral/findings.md) · [topology](spectral/topology.yaml) |
...
| [wowhy/ts-microservice-demo](https://github.com/wowhy/ts-microservice-demo) | 2 | 0 | `nats-node, nest` | [findings](ts-microservice-demo/findings.md) · [topology](ts-microservice-demo/topology.yaml) |
...
| [LEGO/AsyncAPI](https://github.com/LEGO/AsyncAPI.NET) | 1 | 1 | `asyncapi` | [findings](AsyncAPI.NET/findings.md) · [topology](AsyncAPI.NET/topology.yaml) |
...
| [CollatzConjecture/nestjs-clean-architecture](https://github.com/CollatzConjecture/nestjs-clean-architecture) | 0 | 0 | `(none)` | [findings](nestjs-clean-architecture/findings.md) · [topology](nestjs-clean-architecture/topology.yaml) |
| [thangchung/practical-dotnet-aspire](https://github.com/thangchung/practical-dotnet-aspire) | 0 | 0 | `(none)` | [findings](practical-dotnet-aspire/findings.md) · [topology](practical-dotnet-aspire/topology.yaml) |
| [twzhangyang/RestAirline](https://github.com/twzhangyang/RestAirline) | 0 | 0 | `(none)` | [findings](RestAirline/findings.md) · [topology](RestAirline/topology.yaml) |
| [asyncapi/saunter](https://github.com/asyncapi/saunter) | 0 | 0 | `(none)` | [findings](saunter/findings.md) · [topology](saunter/topology.yaml) |
